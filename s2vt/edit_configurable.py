# Non beam search, data size 15760
...
def train_model(model, dataloader, criterion, optimizer, num_epochs, clip = 5,checkpoint_path=None):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        checkpoint_path = f'/home/arifadh/Desktop/checkpoint/s2vt_plain_8/checkpoint_epoch_{epoch+1}.pth'
...
annotation_file = '/home/arifadh/Desktop/Dataset/clean_caption_8.txt'
checkpoint_path = '/home/arifadh/Desktop/checkpoint/s2vt_plain_8/checkpoint_epoch_15.pth'
...
optimizer = optim.Adam(list(model.parameters()), lr=1e-4)
    ...
    # Train model
num_epochs = 20
train_model(model, dataloader, criterion, optimizer, num_epochs, checkpoint_path=checkpoint_path)
