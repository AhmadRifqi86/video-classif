    ...
    def __init__(self, num_classes, sequence_length, hidden_size, rnn_input_size, 
        ...
        if rnn_type == "lstm":
            ...
            self.rnn = nn.ModuleList([ #to be tested: rnn_input_size, rnn_input_size*4, hidden_size, hidden_size,
                ResidualBlock(rnn_input_size, all_config.CONF_SSM_EXPAND, hidden_size, all_config.CONF_SSM_DELTA,  # original: rnn_input_size, rnn_input_size*2, hidden_size, hidden_size//2,
