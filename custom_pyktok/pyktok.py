...
#         if metadata_fn != '':
#             metadata_fn = os.path.join(save_dir, metadata_fn)  # Save metadata to the specified directory
...
#             print("Saved metadata to", metadata_fn)
...
#         tt_urls = video_urls
#     for u in tt_urls:
#         print("call save_tiktok: ",u)
#         save_tiktok(u, save_video, metadata_fn, browser_name, save_dir=save_dir)
#         print("exit from save_tiktok: ")
...
def save_tiktok(video_url,
    ...
    if save_video == False and metadata_fn == '':
        print('Since save_video and metadata_fn are both False/blank, the program did nothing.')
        return
    #print("save_dir inside save_tiktok: ",save_dir)
    tt_json = get_tiktok_json(video_url,browser_name)
    # print("tt_json: ")
    # print(1 if tt_json else 0)
    if tt_json is not None:
        video_id = list(tt_json['ItemModule'].keys())[0]
        print("video_id: ",video_id)
        if save_video == True:
